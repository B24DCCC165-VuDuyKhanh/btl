...
export const postsAPI = {
  ...
  votePost: (id, voteType) => api.post(`/forum/posts/${id}/vote`, { direction: voteType }),
...
export const commentsAPI = {
  ...
  voteComment: (id, voteType) => api.post(`/forum/comments/${id}/vote`, { direction: voteType })
};
